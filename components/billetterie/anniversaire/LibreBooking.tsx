...
export default function LibreBooking() {
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center gap-5 flex-wrap">
        ...
        <div className="flex items-center gap-2">
          <button
            type="button"
            onClick={() => setParticipants((p) => Math.max(8, p - 1))}
        ...
        <span className="font-nunito text-sm text-gray-400">(min. 8 — max. 15 enfants)</span>
      </div>
